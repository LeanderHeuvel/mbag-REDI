...
if __name__=='__main__':
    ...
    #input file names
    csv_file_modality='MG_training_files_cbis-ddsm_singleinstance_groundtruth.csv' #name of the file which contains path to the images and other information of the images. 
