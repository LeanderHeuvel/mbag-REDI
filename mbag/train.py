...
if __name__=='__main__':
    ...
    #input file names
    csv_file_modality=base_path+'mbag-REDI/MG_training_files_cbis-ddsm_singleinstance_groundtruth_adapted.csv' #name of the file which contains path to the images and other information of the images. 
